...
const W = {
  ...
  petalingStreet: fp('Petaling Street, Kuala Lumpur.jpg'),
  brogaHill: fp('Broga Hill.jpg'),
  zooNegaraPanda: fp('Panda Zoo Negara.jpg'),
};
...
export const TRIP_META = {
  ...
  transport: 'Bus, ferry, cable car, 1 internal flight & Grab',
  rate: '1 € ≈ 4.66 MYR',
...
export const BUDGET = [
  { category: 'Accommodation (13 nights)', min: 550, max: 830, note: 'Budget twin-share ÷2 pp · Mid-range = RM1,170+ pp (over budget)' },
  { category: 'Transport', min: 450, max: 555, note: 'Buses, ferries, cable car, 1 flight, Grab' },
  ...
  { category: 'Activities & adventure', min: 928, max: 1038, note: 'Towers, Genting, ESCAPE, SkyCab, kayak, jet ski, Zoo Negara pandas' },
  ...
  { category: 'CORE TOTAL', min: 2848, max: 3653, note: '≈ 611–784 € per person (1€ = 4.66 MYR)', highlight: true },
...
export const BOOKINGS = [
  ...
  { item: 'Flight Langkawi → KL', price: 'RM100–150 pp', source: 'AirAsia / Firefly', url: 'https://www.airasia.com', image: W.petalingStreet, presetId: 'b11' },
  { item: 'Zoo Negara (Giant Pandas)', price: 'RM88 pp', source: 'zoonegara.my', url: 'https://ticket.zoonegara.my/', image: W.zooNegaraPanda, presetId: 'b12' },
...
export const HOTELS = [
  {
    city: 'Kuala Lumpur',
    nights: '3 nights (Days 1-3) + 3 nights (Days 11-13)',
    nightCount: 6,
    dateRanges: [{ checkIn: '22 Jul', checkOut: '25 Jul' }, { checkIn: '01 Aug', checkOut: '04 Aug' }],
...
export const TRANSPORT = [
  ...
  { route: 'Langkawi → Kuala Lumpur', mode: 'Flight (AirAsia/Firefly)', duration: '~1h15m', price: 'RM100–150' },
...
export const CHECKLIST = [
  ...
  { id: 'bank', text: 'Notify your bank of travel dates; withdraw some extra cash for Zoo Negara/Broga Hill drivers' },
...
export const PACKING = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'pk-jacket', text: 'Lightweight rain jacket — monsoon season' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'pk-torch', text: 'Headlamp or phone torch — Broga Hill pre-dawn hike' },
    ],
  },
];
...
export const WARNINGS = [
  ...
  'Broga Hill start is pitch dark — bring a phone torch',
  'Zoo Negara — go early or use the tram, it gets hot by midday',
];
...
export const DAYS = [
  ...
  },
  {
    ...
    tagline: 'Slow morning, quick flight, back to Bukit Bintang',
    cover: W.petalingStreet,
    images: [
      { src: W.pantaiCenang, caption: 'Last Pantai Cenang morning swim' },
      { src: W.petalingStreet, caption: 'Petaling Street lanterns — Chinatown, Kuala Lumpur' },
      { src: W.jalanAlor, caption: 'Dinner back in KL Chinatown' },
      { src: W.klSkyline, caption: 'Bukit Bintang — home for the last 3 nights' },
    ],
    video: { title: 'Petaling Street Chinatown Kuala Lumpur night market' },
    stay: 'Bukit Bintang guesthouse',
    steps: [
      { time: '09:00', title: 'Slow final Pantai Cenang morning', desc: 'Check out, last swim, breakfast on the beach.', images: [W.pantaiCenang] },
      { time: '11:30', title: 'Return scooter, Grab → Langkawi Airport', cost: 'RM15–20 pp' },
      { time: '13:30', title: 'Flight Langkawi → Kuala Lumpur', desc: 'Direct, ~1h15m (AirAsia/Firefly/Malaysia Airlines) — trades the old ferry + two 4h bus rides for one short hop.', cost: 'RM100–150 pp', book: 'https://www.airasia.com' },
      { time: '15:30', title: 'Grab → Bukit Bintang', desc: 'Check in for the last 3 nights.', cost: 'RM30–40 pp' },
      { time: '19:00', title: 'Petaling Street & Chinatown night market', desc: 'Lanterns, street food stalls, no fixed plan — just wander.', images: [W.petalingStreet], mapsUrl: 'https://maps.google.com/?q=Petaling+Street+Kuala+Lumpur' },
      { time: '20:00', title: 'Dinner — Chinatown / Jalan Alor', cost: 'RM25–35 pp', halal: true, images: [W.jalanAlor] },
    ],
  },
  {
    day: 12,
    ...
    tagline: 'Pre-dawn hike, rolling hill views, then a real rest day',
    cover: W.brogaHill,
    images: [
      { src: W.brogaHill, caption: 'Broga Hill sunrise — Selangor, Malaysia' },
      { src: W.brogaHill, caption: 'Rolling hill views from the peak' },
      { src: W.klSkyline, caption: 'Back in Bukit Bintang for a lazy afternoon' },
      { src: W.jalanAlor, caption: 'Dinner near the hotel' },
    ],
    video: { title: 'Broga Hill sunrise hike Malaysia guide' },
    stay: 'Bukit Bintang',
    steps: [
      { time: '04:30', title: 'Grab/private transfer to Broga Hill', desc: '~40 min from KL — no public transport running this early.', cost: 'RM40–60 pp', tip: 'Book the driver the night before', images: [W.brogaHill], mapsUrl: 'https://maps.google.com/?q=Broga+Hill+Selangor+Malaysia' },
      { time: '05:15', title: 'Hike to the peak', desc: 'Easy-moderate, ropes on the steeper sections, 30–45 min, no experience needed.', tip: 'Bring a torch/headlamp — still dark at the start' },
      { time: '07:00', title: 'Sunrise at the peak', desc: 'Rolling Selangor hill views over the clouds.', images: [W.brogaHill] },
      { time: '08:30', title: 'Grab back to Bukit Bintang', cost: 'RM40–60 pp' },
      { time: '10:00', title: 'Late breakfast + nap/pool', desc: 'Explicitly free time, no itinerary — the deliberate rest day.' },
      { time: '19:00', title: 'Dinner near Bukit Bintang', cost: 'RM25–35 pp', halal: true },
    ],
  },
  {
    day: 13,
    ...
    city: 'Kuala Lumpur',
    theme: 'Zoo Negara',
    tagline: 'Giant pandas, last squad dinner, pack up',
    cover: W.zooNegaraPanda,
    images: [
      { src: W.zooNegaraPanda, caption: 'Giant panda — Zoo Negara Conservation Centre, Kuala Lumpur' },
      { src: W.zooNegaraPanda, caption: 'Xing Xing & Liang Liang, Malaysia\'s only giant pandas' },
      { src: W.jalanAlor, caption: 'Final squad dinner — Jalan Alor' },
      { src: W.klSkyline, caption: 'Pack for tomorrow\'s flight' },
    ],
    video: { title: 'Zoo Negara panda Kuala Lumpur' },
    stay: 'Bukit Bintang — rest night',
    steps: [
      { time: '09:00', title: 'Grab → Zoo Negara', desc: 'Ampang, ~25–30 min.', cost: 'RM25–35 pp', mapsUrl: 'https://maps.google.com/?q=Zoo+Negara+Malaysia' },
      { time: '09:30', title: 'Zoo Negara + Giant Panda Conservation Centre', desc: 'Xing Xing & Liang Liang, Malaysia\'s only giant pandas, included in general admission.', cost: 'RM88 pp', book: 'https://ticket.zoonegara.my/', images: [W.zooNegaraPanda], tip: 'Take the tram to avoid walking in the heat' },
      { time: '13:00', title: 'Grab back to Bukit Bintang', cost: 'RM25–35 pp' },
      { time: '16:00', title: 'Free time', desc: 'Last-minute shopping or rest.' },
      { time: '19:00', title: 'Final squad dinner', desc: 'Jalan Alor.', cost: 'RM30–35 pp', images: [W.jalanAlor], mapsUrl: 'https://maps.google.com/?q=Jalan+Alor+Kuala+Lumpur+Malaysia' },
...
export const BOOKING_PRESETS = [
  ...
  { id: 'b11', day: 11, label: 'Flight Langkawi → KL', estMin: 100, estMax: 150, url: 'https://www.airasia.com' },
  { id: 'b12', day: 13, label: 'Zoo Negara (Giant Pandas)', estMin: 88, estMax: 88, url: 'https://ticket.zoonegara.my/' },
];
